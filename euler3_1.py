...
# We split it up into two forms to minimize time taken: whether we need to treat it as potential addention to our prime list or whether
# to identify whether or not i is prime and whether it's able to be stripped from z.
